...
- ## Manual
    - ### Dependancies
        #### Arch
        > ```sh
        > yay -S hyprland foot grim slurp awww fish swaylock swayidle sassc starship ttf-ibm-plex cava imagemagick gnome-bluetooth-3.0 wl-clipboard libdbusmenu-gtk3 xorg-xrandr cpio cmake git meson gcc curl pipewire pipewire-pulse wireplumber bluez bluez-utils networkmanager libnotify gawk coreutils grep
        > ```
        #### STTT
