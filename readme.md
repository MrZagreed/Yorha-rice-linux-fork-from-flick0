...
- ## Manual
    ...
    - ### Apply theme
      ...
      - The installer automatically installs the repository `hyprland.conf` when it finds an autogenerated config and saves the old file as a timestamped backup.
